...
# This scripts train the models on CIC-IDS2017-Friday PCAP traffic trace.
...
data_folder=CIC-IDS-2017/friday
./run.sh --input-pcap-file $data_folder/Friday-WorkingHours.pcap \
         --output-pcaps-folder fri_pcap_splitted \
         --output-csvs-folder fri_pcap_splitted/csvs \
